#ifndef HOT_MANIFEST_PATH_H
#define HOT_MANIFEST_PATH_H

#include <stdbool.h>
#include <stddef.h>
#include <stdint.h>

// hot/manifest_path.h — the MANIFEST(...) install-layout authority.
//
...
// See _docs/install.md for the full process.
...
// Update staging: verify the staged set in bin/new is a complete, integrity-
// passed HotStage package (hot.manifest + files.sha + payloads).
// Verify only — never promotes. Returns true when a promotion is safe.
